package com.wn.quickrechatge.net;

import android.text.TextUtils;

import com.alibaba.fastjson.JSON;
import com.wn.quickrechatge.httpresponse.BaseResponse;
import com.wn.quickrechatge.httpresponse.MyResponseInfo;
import com.wn.quickrechatge.utils.Tool;
...
public class MyHttpUtils<T> {
    ...
    public Callback.Cancelable get(final String url, RequestParams maps, final HttpCallback<T> callback) {
     ...
     * get 请求
     *
     * @param url      请求地址（域名后的那一串）
     * @param maps     参数
     * @param callback 回调
     * @param httpCode 网络请求响应吗
     */
    public Callback.Cancelable get(final String url, RequestParams maps, final HttpCallback<T> callback, final int httpCode) {
        return httpRequestIml(HttpMethod.GET, url, maps, callback, httpCode);
    }
     ...
     * @param httpCode 网络请求响应吗
     */
    public Callback.Cancelable delete(final String url, RequestParams maps, final HttpCallback<T> callback, final int httpCode) {
        return httpRequestIml(HttpMethod.DELETE, url, maps, callback, httpCode);
    }

    public Callback.Cancelable put(final String url, RequestParams maps, final HttpCallback<T> callback) {
     ...
     * @param httpCode 网络请求响应吗
     */
    public Callback.Cancelable put(final String url, RequestParams maps, final HttpCallback<T> callback, final int httpCode) {
        return httpRequestIml(HttpMethod.PUT, url, maps, callback, httpCode);
    }
     ...
     * @param callback
     */
    public Callback.Cancelable post(String url, RequestParams maps, final HttpCallback<T> callback) {
     ...
     * @param httpCode 网络请求响应吗
     */
    public Callback.Cancelable post(final String url, RequestParams maps, final HttpCallback<T> callback, final int httpCode) {
        return httpRequestIml(HttpMethod.POST, url, maps, callback, httpCode);
    }
     ...
     * @param httpCode 网络请求响应吗
     */
    private Callback.Cancelable httpRequestIml(HttpMethod method, final String url, RequestParams params, final HttpCallback callback, final int httpCode) {
